			...
			<ul class="nav" id="side-menu">
				<li class="nav-header">
					...
					<div class="dropdown profile-element">
						<span> <img alt="image" class="img-circle"
							src="<%=basePath%>resource/img/profile_small.jpg" />
						...
						<ul class="dropdown-menu animated fadeInRight m-t-xs">
							...
							<li class="divider"></li>
							<li><a href="javascript:void(0);" onclick="sigup()">安全退出</a>
							</li>
						</ul>
					</div>
				...
				<li><a href="index.html#"><i class="fa fa-desktop"></i> <span
					...
					<ul class="nav nav-second-level">
						...
						<li><a href="javascript:void(0);" onclick="sigup()">登录</a></li>
				...
				<li><a href="index.html#"><i class="fa fa-picture-o"></i> <span
						class="nav-label">图库</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="row border-bottom">
				...
				<ul class="nav navbar-top-links navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle count-info"
						...
						<ul class="dropdown-menu dropdown-messages">
							<li>
								<div class="dropdown-messages-box">
									<a href="profile.html" class="pull-left"> <img alt="image"
										class="img-circle" src="<%=basePath%>resource/img/a7.jpg">
									</a>
							...
							<li>
								<div class="dropdown-messages-box">
									<a href="profile.html" class="pull-left"> <img alt="image"
										class="img-circle" src="<%=basePath%>resource/img/a4.jpg">
									</a>
									<div class="media-body ">
					...
					<li><a href="javascript:void(0);" onclick="sigup()"><i class="fa fa-sign-out"></i> 退出
					</a></li>
				</ul>
			...
			<div class="row  border-bottom white-bg dashboard-header">
				...
				<div class="col-sm-3">
					...
					<small>移动设备访问请扫描以下二维码：</small> <br> <br> <img
						src="<%=basePath%>resource/img/qr_code.png" width="100%"
				...
				<div class="col-sm-5">
					...
					<p>
						<a class="btn btn-success btn-outline"
							...
							href="http://www.zi-han.net" target="_blank"> <i
			...
			<div class="row">
							...
							<div class="col-lg-4">
								<div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										...
										<p>
											<img src="<%=basePath%>resource/img/alipay_qr_code.png"
												width="100%" style="max-width: 369px">
										</p>
				...
				<div class="footer">
					<div class="pull-right">
						By：<a href="http://www.zi-han.net" target="_blank">zihan's
							blog</a>
					</div>
					<div>
...
<script type="text/javascript">
	...
	window.location.href=WebRoot+"login.do";
	}
</script>
</html>