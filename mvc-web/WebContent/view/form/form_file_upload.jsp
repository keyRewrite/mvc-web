...
<head>
    ...
    <link href="<%=basePath%>resource/css/plugins/dropzone/basic.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/dropzone/dropzone.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="<%=basePath%>resource/js/plugins/dropzone/dropzone.js"></script>
    <script>
