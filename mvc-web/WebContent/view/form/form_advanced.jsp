...
<head>
    ...
    <link href="<%=basePath%>resource/css/plugins/chosen/chosen.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/cropper/cropper.min.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/switchery/switchery.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/jasny/jasny-bootstrap.min.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/nouslider/jquery.nouislider.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/datapicker/datepicker3.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/ionRangeSlider/ion.rangeSlider.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/clockpicker/clockpicker.css" rel="stylesheet">
...
<body class="gray-bg">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-crop">
                                    <img src="<%=basePath%>resource/img/a3.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h4>图片预览：</h4>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 	...
 	<script src="<%=basePath%>resource/js/plugins/chosen/chosen.jquery.js"></script>
    <script src="<%=basePath%>resource/js/plugins/jsKnob/jquery.knob.js"></script>
    <script src="<%=basePath%>resource/js/plugins/jasny/jasny-bootstrap.min.js"></script>
    <script src="<%=basePath%>resource/js/plugins/datapicker/bootstrap-datepicker.js"></script>
    <script src="<%=basePath%>resource/js/plugins/prettyfile/bootstrap-prettyfile.js"></script>
    <script src="<%=basePath%>resource/js/plugins/nouslider/jquery.nouislider.min.js"></script>
    <script src="<%=basePath%>resource/js/plugins/switchery/switchery.js"></script>
    <script src="<%=basePath%>resource/js/plugins/ionRangeSlider/ion.rangeSlider.min.js"></script>
    ...
    <script src="<%=basePath%>resource/js/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
    <script src="<%=basePath%>resource/js/plugins/clockpicker/clockpicker.js"></script>
    <script src="<%=basePath%>resource/js/plugins/cropper/cropper.min.js"></script>
    <script src="<%=basePath%>resource/js/demo/form-advanced-demo.min.js"></script>
</body>
