...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>resource/css/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath%>resource/css/demo/webuploader-demo.min.css">
...
<body class="gray-bg">
    ...
    <script src="<%=basePath%>resource/js/plugins/webuploader/webuploader.min.js"></script>
    <script src="<%=basePath%>resource/js/demo/webuploader-demo.min.js"></script>
