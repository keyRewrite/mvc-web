                    ...
                    <div class="ibox-content">
                        ...
                        <div class="m-t m-b">
                            ...
                            <div id="userAlbums" style="display:none">
                                <a href="<%=basePath%>resource/img/a1.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a1.jpg" alt="示例图片1" />
                                </a>
                                <a href="<%=basePath%>resource/img/a2.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a2.jpg" alt="示例图片2" />
                                </a>
                                <a href="<%=basePath%>resource/img/a3.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a3.jpg" alt="示例图片2" />
                                </a>
                                <a href="<%=basePath%>resource/img/a4.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a4.jpg" alt="示例图片2" />
                                </a>
                                <a href="<%=basePath%>resource/img/a5.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a5.jpg" alt="示例图片2" />
                                </a>
                                <a href="<%=basePath%>resource/img/a6.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a6.jpg" alt="示例图片2" />
                                </a>
                                <a href="<%=basePath%>resource/img/a7.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a7.jpg" alt="示例图片2" />
                                </a>
                                <a href="<%=basePath%>resource/img/a8.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a8.jpg" alt="示例图片2" />
                                </a>
                                <a href="<%=basePath%>resource/img/a9.jpg" class="fancybox" title="选取该照片">
                                    <img src="<%=basePath%>resource/img/a9.jpg" alt="示例图片2" />
                                </a>>
                            </div>
                        </div>
