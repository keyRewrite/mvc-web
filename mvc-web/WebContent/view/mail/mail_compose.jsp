...
<head>
    ...
    <link href="<%=basePath%>resource/css/plugins/summernote/summernote.css" rel="stylesheet">
    <link href="<%=basePath%>resource/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">
...
<body class="gray-bg">
  ...
  <%@include file="../../common/footer.jsp" %>
   <script src="<%=basePath%>resource/js/plugins/summernote/summernote.min.js"></script>
    <script src="<%=basePath%>resource/js/plugins/summernote/summernote-zh-CN.js"></script>
    <script>
