                ...
                <div class="ibox float-e-margins">
                    ...
                    <div>
                        <div class="ibox-content no-padding border-left-right">
                            <img alt="image" class="img-responsive" src="<%=basePath%>resource/img/profile_big.jpg">
                        </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="<%=basePath%>view/usermanager/profile.jsp">
                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="<%=basePath%>resource/img/a1.jpg">
                                    </a>
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="<%=basePath%>resource/img/profile.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="<%=basePath%>resource/img/a2.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="<%=basePath%>resource/img/a3.jpg">
                                    </a>
                                    <div class="media-body ">
                                        ...
                                        <div class="photos">
                                            <a target="_blank" href="../../../24.media.tumblr.com/20a9c501846f50c1271210639987000f/tumblr_n4vje69pJm1st5lhmo1_1280.jpg">
                                                <img alt="image" class="feed-photo" src="<%=basePath%>resource/img/p1.jpg">
                                            </a>
                                            <a target="_blank" href="../../../37.media.tumblr.com/9afe602b3e624aff6681b0b51f5a062b/tumblr_n4ef69szs71st5lhmo1_1280.jpg">
                                                <img alt="image" class="feed-photo" src="<%=basePath%>resource/img/p3.jpg">
                                            </a>
                                        </div>
                                    </div>
                                </div>
