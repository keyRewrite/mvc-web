...
public class RsaEncryotConstroller {
	...
	public @ResponseBody Map<String, Object> login(HttpServletRequest request,
		...
		map.put("strPublicKeyExponent", recoveryPubKey.getPublicExponent().toString(16));
		map.put("strPublicKeyModulus", recoveryPubKey.getModulus().toString(16));
		log.debug("strPublicKeyExponent:"+recoveryPubKey.getPublicExponent().toString(16));
		log.debug("strPublicKeyModulus:"+recoveryPubKey.getModulus().toString(16));
		return  map;
	}
